...
import 'package:housing_hub/classess/Finnace.dart';
...
class AddProperty extends StatefulWidget {
  ...
  AddProperty({required this.user,required this.allProperties });
  final User user;
...
class _AddPropertyState extends State<AddProperty> {
  ...
  Uploadingindb()async {
    ...
    Property newproperty=new Property.full(propertyType: selectedtype, user:widget.user, city: selectedcity,
        ...
        title: titleController.text, description: descriptionController.text, images:_selectedImages,);
         if(isInstallmentAvailable){
           Finnace finnace =Finnace.full(advanceAmount:double.parse(advanceAmountController.text),
             installmentAmount: double.parse(installmentAmountController.text),
               noOfInstallments:int.parse(noOfInstallmentsController.text));
           newproperty.setFinnace(finnace);
         }

    result=await newproperty.postProperty();
    widget.allProperties=(await newproperty.FetchingProperties(null,null))!;
    }catch(e){
      result=e.toString();
    }
    finally{
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          backgroundColor: result=='Property Posted successfully'?Colors.green:Colors.red,
        content: Text(result),
      ),
    );
        ...
        Column(
          ...
          children: [
            ...
            Container(
              ...
              child: _InputForm("Description","Enter Title e.g Beautiful new House", "",false,descriptionController),
            ),
          ],
        ),
      ],
